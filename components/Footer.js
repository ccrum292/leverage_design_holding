...
export default function Footer(props) {
  return (
    <div className="flex flex-col justify-center border-black border-t-2 pt-2">
      <div className="flex justify-around">
        ...
        <Link href="/contact">
            <h4 className="cursor-pointer overflow-x-hidden truncate text-black jost transition duration-500 ease-in-out transform hover:font-black">Contact Info</h4>
        </Link>
      </div>
