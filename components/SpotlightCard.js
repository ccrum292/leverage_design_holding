			...
			<div className="relative w-full">
				...
				<div className="absolute bottom-0 my-auto w-full h-full flex items-center  justify-between">
					<FontAwesomeIcon
						...
						className="no-select cursor-pointer ml-1 opacity-75 transition duration-700 ease-in-out transform sm:hover:opacity-100 sm:hover:scale-110"
						style={{ color: '#ecc94b' }}
						size="2x"
						icon={faChevronLeft}
					/>
					<FontAwesomeIcon
						...
						className="no-select cursor-pointer mr-1 opacity-75 transition duration-700 ease-in-out transform sm:hover:opacity-100 sm:hover:scale-110"
						style={{ color: '#ecc94b' }}
						size="2x"
						icon={faChevronRight}
					/>
					<FontAwesomeIcon
						...
						className="no-select absolute bottom-0 right-0 cursor-pointer m-1 opacity-75 transition duration-700 ease-in-out transform sm:hover:opacity-100 sm:hover:scale-110"
						style={{ color: '#ecc94b' }}
						size="2x"
						icon={faExpandAlt}
					/>
				...
				<div className="fixed top-0 left-0 min-h-screen min-w-full z-50 bg-gray-800 bg-opacity-90 flex justify-center items-center">
					...
					<div className="absolute bottom-0 my-auto w-full h-full flex items-center  justify-between">
						...
						<FontAwesomeIcon
							...
							className="no-select absolute top-0 right-0 cursor-pointer mr-4 mt-2 opacity-75 transition duration-700 ease-in-out transform sm:hover:opacity-100 sm:hover:scale-110"
							style={{ color: '#ecc94b' }}
							size="2x"
							icon={faTimes}
						/>
